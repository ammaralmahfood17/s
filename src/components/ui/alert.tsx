...
const alertVariants = cva(
  "relative w-full rounded-lg border border-oklch(0.922 0 0) p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-oklch(0.145 0 0) dark:border-oklch(1 0 0 / 10%) dark:[&>svg]:text-oklch(0.985 0 0)",
  {
    variants: {
      variant: {
